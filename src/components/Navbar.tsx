...
// // import { SignInButton, SignOutButton } from "./ui/auth-buttons";
...
//   // const [user, setUser] = useState<null | typeof session>(null)
            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent side="left" className="pr-0 sm:max-w-xs">
                ...
                <div className="my-4 h-[calc(100vh-8rem)] pb-10 pl-6">
                  {/* Mobile Nav Links */}
                  <div className="flex flex-col space-y-3">
                    <Link href="/" onClick={() => setOpen(false)} className="text-foreground/70 hover:text-foreground">
                      Home
                    </Link>
                    <Link href="/products" onClick={() => setOpen(false)} className="text-foreground/70 hover:text-foreground">
                      Products
                    </Link>
                    <Link href="/services" onClick={() => setOpen(false)} className="text-foreground/70 hover:text-foreground">
                      Services
                    </Link>
                    <Link href="/gallery" onClick={() => setOpen(false)} className="text-foreground/70 hover:text-foreground">
                      Gallery
                    </Link>
                    <Link href="/about" onClick={() => setOpen(false)} className="text-foreground/70 hover:text-foreground">
                      About
                    </Link>
                    <Link href="/contact" onClick={() => setOpen(false)} className="text-foreground/70 hover:text-foreground">
                      Contact
                    </Link>
                  </div>
                  ...
                  <div className="mt-8 flex flex-col space-y-3">
                    <SignedOut>
                      <SignInButton mode="modal">
                        <Button variant="outline" className="w-full justify-start bg-transparent" onClick={() => setOpen(false)}>
                          Login
                        </Button>
                      </SignInButton>
                      <SignUpButton mode="modal">
